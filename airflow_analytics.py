...
with DAG('analytics_dag',
        ...
        task_id= 'extract_data_var',
        python_callable=extract_data,
        )

        load_to_s3 = BashOperator(
            task_id = 'tsk_load_to_s3',
            bash_command = 'aws s3 mv {{ ti.xcom_pull("extract_data_var")[0]}} s3://thanhvv_honda_bucket/',
        )

        is_file_in_s3_available = S3KeySensor(
        task_id='tsk_is_file_in_s3_available',
        bucket_key='{{ti.xcom_pull("extract_data_var")[1]}}',
        ...
        s3_bucket=s3_bucket,
        s3_key='{{ti.xcom_pull("extract_data_var")[1]}}',
        schema="PUBLIC",
        table="zillowdata",
        ...
        extract_data_var >> load_to_s3 >> is_file_in_s3_available >> transfer_s3_to_redshift